        ...
        <div className={cx('wrapper')}>
            {!isLoggedIn ? (
                ...
                <div className={cx('live-area')}>
                    <div className={cx('live-area-header')}>{i18n.t('HOMEMESSAGE_watch_together')}</div>
                            ...
                            return (
                                <div className={cx('live-item')}>
                                    ...
                                    <div className={cx('live-name')}>
                                        ...
                                        <div className={cx('living')}>{i18n.t('HOMEMESSAGE_living')}</div>
                                        <Button
                                            primary
                                            onClick={() => {
